        ...
        <div className="remaster-auth-card auth-glass-card rounded-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] overflow-hidden">
          <div className="relative px-8 py-10 text-center auth-divider">
            <div className="flex justify-center mb-4 relative">
              <div
                className="w-36 h-36 rounded-full bg-gradient-to-br from-cyan-950 via-sky-900 to-blue-950 flex items-center justify-center transition-all duration-300 overflow-hidden border border-cyan-300/35 shadow-[0_0_36px_rgba(34,211,238,0.24)]"
              >
                <img
                  src="/koda-mark.png"
                  alt="KODA"
